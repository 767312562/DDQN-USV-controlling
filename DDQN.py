...
class DoubleDQN:
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net'):
            ...
            c_names, n_l1, n_l2, n_l3, w_initializer, b_initializer = \
                ['eval_net_params', tf.GraphKeys.GLOBAL_VARIABLES], 16, 32, 64, \
        ...
        with tf.variable_scope('target_net'):
            # c_names(collections_names) are the collections to store variables
            c_names, n_l1, n_l2, n_l3, w_initializer, b_initializer = \
                ['target_net_params', tf.GraphKeys.GLOBAL_VARIABLES], 16, 32, 64, \
                tf.random_normal_initializer(0., 0.3), tf.constant_initializer(0.1)  # config of layers
    ...
    def learn(self):
        ...
        loss_save = 'D:\\Wave glider modelling\\data\\#10\\loss.json'
    ...
    def saver(self):
        ...
        saver.save(self.sess, 'D:\\Wave glider modelling\\data\\#10\\#10')
